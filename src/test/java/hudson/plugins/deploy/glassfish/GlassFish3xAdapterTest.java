...
public class GlassFish3xAdapterTest {
    ...
    //    Assert.assertEquals(adapter.adminPort, port);
        ...
        Container container = adapter.getContainer(VariableResolver.NONE, configFactory, containerFactory, adapter.getContainerId());
   ...
   //     Assert.assertEquals(remoteAdapter.adminPort, adminPort);
        ...
        Container container = remoteAdapter.getContainer(VariableResolver.NONE, configFactory, containerFactory, remoteAdapter.getContainerId());
        Assert.assertNotNull(container);
    }
